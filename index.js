...
const bookDir = path.join(__dirname, 'AngularCourse');
const contentFilePath = path.join(__dirname, 'content-angular.md')
const getPrompt = (chapterTitle, sectionTitle) => `
  Представь себя автором курса по Angular, цель которого — сделать сложные концепции доступными для широкой аудитории. 
  Избегай сложных технических терминов и объясняй всё так, чтобы даже человек, незнакомый с Angular, смог понять суть. 
  Постарайся делать объяснения интересными и увлекательными.
  Основная цель курса — на практических примерах изучить Angular и подготовиться к собеседованию. Делай акцент на практику и большое количество примеров кода.
